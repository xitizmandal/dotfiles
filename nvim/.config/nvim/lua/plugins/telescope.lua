...
vim.api.nvim_set_keymap('n', ',ff',
    "<cmd> lua require('telescope.builtin').find_files{find_command={'rg', '--files', '--hidden', '--smart-case', '--glob', '!**/{.git,__pycache__,node_modules,vendor}/*'}}<cr>"
    , { noremap = true })
...
vim.api.nvim_set_keymap('n', ',fl', "<cmd> lua require('telescope.builtin').lsp_document_diagnostics()<cr>",
    { noremap = true })
vim.api.nvim_set_keymap('n', ',fw', "<cmd> lua require('telescope.builtin').lsp_workspace_diagnostics()<cr>",
    { noremap = true })
